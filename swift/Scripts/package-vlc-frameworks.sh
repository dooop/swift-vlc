...
Steps:
  1. downloads/installs the xcframeworks via swift/Scripts/update-vlc-frameworks.sh
     (skipped with --no-download if swift/Frameworks/ is already populated)
...
Environment overrides:
  FRAMEWORKS_DIR  Source/destination folder for *.xcframework (default: ./swift/Frameworks)
...
FRAMEWORKS_DIR="${FRAMEWORKS_DIR:-$SWIFT_ROOT/Frameworks}"
